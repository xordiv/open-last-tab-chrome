...
С открытым исходным кодом и требует только доступ к вкладкам и хранилищу. Хранилище используется для сохранения порядка вкладок при перезапуске service worker браузером.
